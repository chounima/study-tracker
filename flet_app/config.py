"""Constants shared across the Flet app. Values are ported 1:1 from the
original Tkinter app's app/config.py so existing exam_progress.json data
(and user habits) keep working."""

STORAGE_KEY = "study_tracker_data"
